          ...
          <article className="flex flex-wrap basis-1/2 gap-4 justify-center">
            <div className="card-div">
                <div className="rounded-lg shadow-lg bg-white max-w-sm">
                    <span >
                        <img className="card-image rounded-t-lg" src="./assets/images/noodles.jpg" alt=""/>
                    </span>
                        <div className="text-center p-6">
                            ...
                            <h2 className="food-category text-black">{restaurant.foodType}</h2>
                            <h2 className="address text-black text-sm mb-2">{restaurant.address}</h2>
                            <h2 className="description text-[#BE95FA] mb-4">{restaurant.description}</h2>
